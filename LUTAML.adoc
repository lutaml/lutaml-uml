...
----
association name {
  owned_end_type association|composition|aggregation|generalization|uses
  member_end_type association|composition|aggregation|generalization|uses
  owned_end association_name[#attribute_name] [{property_string}][cardinality]
  member_end association_name[#attribute_name] [{property_string}][cardinality]
}
----

where:

* `owned_end_type` - optional, use to define bidirectional association(association|composition|aggregation|generalization|uses)
* `member_end_type` - association type(association|composition|aggregation|generalization|uses)
* `owned_end|member_end` - end of association, use `\#attribute_name` to set a role name
